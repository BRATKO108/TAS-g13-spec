...
\addnumberedsinglerow{}{\msrcode{actCoordinatorMobility[active, multiple]}}
...
\addalphanumberedsinglerow{}{the actor \msrcode{actCoordinatorMobility} executes the \msrucname{suGlobalCrisisHandling} use case}
