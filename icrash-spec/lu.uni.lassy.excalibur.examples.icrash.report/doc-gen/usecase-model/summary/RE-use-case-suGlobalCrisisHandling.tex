...
\addnumberedsinglerow{}{\msrcode{actCoordinatorMobility[active]}}
...
\addalphanumberedsinglerow{}{the actor \msrcode{actCoordinatorMobility} executes the \msrucname{ugSecurelyUseSystem} use case}
\addalphanumberedsinglerow{}{the actor \msrcode{actCoordinatorMobility} executes the \msrucname{ugMonitor} use case}
