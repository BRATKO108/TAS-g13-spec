...
\addnumberedsinglerow{}{\msrucname{oeSetCrisisTime [0..*]}}
...
\addalphanumberedsinglerow{}{the actor \msrcode{actCoordinator} executes the \msrucname{oeSetCrisisTime} use case}
