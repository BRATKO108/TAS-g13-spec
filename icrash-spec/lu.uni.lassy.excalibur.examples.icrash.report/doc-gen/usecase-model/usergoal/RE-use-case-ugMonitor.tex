...
\addalphanumberedsinglerow{}{the actor \msrcode{actCoordinatorMobility} executes the \msrucname{oeGetAlertsSet} use case}
\addalphanumberedsinglerow{}{the actor \msrcode{actCoordinatorMobility} executes the \msrucname{oeGetCrisisSet} use case}
